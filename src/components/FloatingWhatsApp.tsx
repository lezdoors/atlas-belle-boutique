...
const FloatingWhatsApp = () => {
  ...
  return (
    <Button
      ...
      size="icon"
      className="fixed bottom-6 right-6 z-[9999] h-14 w-14 rounded-full bg-green-500 hover:bg-green-600 text-white luxury-shadow hover:shadow-2xl transition-all duration-300 hover-scale animate-float"
