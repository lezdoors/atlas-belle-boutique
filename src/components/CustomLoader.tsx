      ...
      >
        <div className="text-center">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center">
              <img 
                ...
                className="h-20 w-20 mx-auto filter drop-shadow-lg relative z-10 logo-float object-contain"
                style={{
              ...
              {/* Shimmer overlay */}
              <div 
                className="absolute inset-0 rounded-full opacity-0 shimmer-overlay"
                style={{
          ...
          <div className="flex justify-center space-x-2 mt-6">
            <div className="w-2 h-2 bg-amber-400 rounded-full dot-pulse-1" />
            <div className="w-2 h-2 bg-copper-400 rounded-full dot-pulse-2" />
            <div className="w-2 h-2 bg-pearl-400 rounded-full dot-pulse-3" />
          </div>
        </div>
      </div>
    </>
